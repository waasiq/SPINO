...
class ViTAdapter(DinoVisionTransformer):
    def __init__(self, pretrain_size=518, conv_inplane=64, n_points=4,
        ...
        # --- MODIFICATION START ---
        # CRITICAL: More conservative freezing strategy for ViT-Adapter
        # We need to freeze most of the backbone but keep adapters trainable
        print(f"Applying conservative parameter freezing...")
