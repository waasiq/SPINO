...
from fine_tuning_eva02 import EVA02FineTuner
...
class BoundaryFineTuner(EVA02FineTuner):
    """ Fine-tunes a small head on top of the EVA02 model for boundary estimation.

    Parameters
    ----------
    eva02_model : str
        EVA02 model name. One of ['tiny_patch14_196', 'small_patch14_196', 'base_patch14_224', 
        'large_patch14_224', 'large_patch14_336', 'large_patch14_448'].
    mode : str
        One of ['affinity', 'direct']. If 'affinity', predict affinity. If 'direct', predict
        boundary directly.
    upsample_factor : float
        Upsample factor of the feature map after the EVA02 and before the head.
    head : str
    ...
    use_vitadapter : bool
        Whether to use a ViTAdapter for the EVA02 model.
    use_vitcomer : bool  
        Whether to use ViTCoMer for the EVA02 model.
    """

    def __init__(self, eva02_model: str, mode: str = 'direct',
