...
class SemanticFineTuner(EVA02FineTuner):
    ...
    def __init__(self, eva02_model: str, num_classes: int, train_output_size: Tuple[int, int],
        ...
        super().__init__(eva02_model=eva02_model, blocks=blocks,
