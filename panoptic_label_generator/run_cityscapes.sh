...
#python panoptic_label_generator/boundary_fine_tuning.py fit --trainer.devices [0] --config panoptic_label_generator/configs/boundary_cityscapes.yaml > panoptic_label_generator/logs/vit-logs/boundary_cityscapes.txt 2>&1
...
#python -m panoptic_segmentation_model.scripts_dev.evaluate_labels --dataset_name cityscapes --gpu_id 0 /work/dlclarge2/masoodw-spino100/dl-lab/cityscapes /work/dlclarge2/masoodw-spino100/dl-lab/cityscapes/results/cityscapes_lora_mlp
