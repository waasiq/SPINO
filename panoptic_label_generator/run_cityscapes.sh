...
#python panoptic_label_generator/semantic_fine_tuning.py fit --trainer.devices [0] --config panoptic_label_generator/configs/semantic_cityscapes.yaml > panoptic_label_generator/logs/semantic_cityscapes_vitcomer_mlp.txt 2>&1
#python panoptic_label_generator/boundary_fine_tuning.py fit --trainer.devices [0] --config panoptic_label_generator/configs/boundary_cityscapes.yaml > panoptic_label_generator/logs/boundary_cityscapes_vitcomer_mlp_run2.txt 2>&1
python panoptic_label_generator/instance_clustering.py test --trainer.devices [0] --config panoptic_label_generator/configs/instance_cityscapes.yaml > panoptic_label_generator/logs/instance_cityscapes_vitcomer_mlp.txt 2>&1
